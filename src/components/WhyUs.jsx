...
const reasons = [
  ...
  { num: '02', title: 'Holistic Approach',     desc: 'We consider every aspect — light, flow, acoustics, and aesthetics — for a truly cohesive result.' },
  { num: '03', title: 'Design Excellence',     desc: 'Award-winning designers who push boundaries of innovation while honoring timeless principles of beauty.' },
  { num: '04', title: 'Transparent Service',   desc: 'Clear timelines, honest pricing, and open communication from first consultation to final handover.' },
