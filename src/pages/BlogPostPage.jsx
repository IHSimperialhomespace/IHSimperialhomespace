  ...
  "wooden-interior-design-trends-2025": {
    ...
    content: [
      ...
      },
      {
        ...
        caption:
          "Fluted wood panel bedroom — IHS Imperial Home Space, Hyderabad",
      },
      {
        type: "heading",
  ...
  "modular-kitchen-guide": {
    ...
    content: [
      ...
      },
      {
        ...
        caption:
          "U-shaped modular kitchen with island — IHS Imperial Home Space project",
      },
      {
        type: "heading",
  ...
  "false-ceiling-design-ideas": {
    ...
    content: [
      ...
      },
      {
        ...
        caption:
          "Wood slatted ceiling in luxury bedroom — IHS Imperial Home Space",
      },
      {
        type: "heading",
  ...
  "wardrobe-design-guide": {
    ...
    content: [
      ...
      },
      {
        ...
        caption:
          "Custom built-in wardrobe with sliding doors — IHS Imperial Home Space",
      },
      {
        type: "heading",
  ...
  "interior-design-cost-hyderabad": {
    ...
    content: [
      ...
      },
      {
        ...
        caption:
          "Premium interior design project by IHS Imperial Home Space, Hyderabad",
      },
      {
        type: "heading",
  ...
  "living-room-design-ideas-2025": {
    ...
    content: [
      ...
      },
      {
        ...
        caption:
          "Modern Indian living room with statement TV unit — IHS Imperial Home Space",
      },
      {
        type: "heading",
      ...
      <article className="blogpost-body section">
        <div className="blogpost-container">
          {article.content.map((block, i) => {
            if (block.type === "intro")
              return (
                <p key={i} className="blogpost-intro">
                  {block.text}
                </p>
              );
            if (block.type === "heading")
              return (
                <h2 key={i} className="blogpost-heading">
                  {block.text}
                </h2>
              );
            if (block.type === "paragraph")
              return (
                <p key={i} className="blogpost-paragraph">
                  {block.text}
                </p>
              );
            if (block.type === "image")
